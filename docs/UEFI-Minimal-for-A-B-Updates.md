...
reliability of and over-the-air update process that performs combined
...
Partition. Power failures while updating the `BOOTAA64.EFI` on the
ESP would render the system unbootable, since there would be no OS
launcher available.
